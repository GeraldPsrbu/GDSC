...
function Todo() {
	...
	const [filter, setFilter] = useState("all"); // Menambah state untuk filter
	...
	// Menambahkan fungsi untuk menandai tugas sebagai selesai/belum selesai
	function toggleFilter(status) {
		setFilter(status);
	}

	// Menambahkan fungsi untuk menyaring tugas berdasarkan status (selesai/belum selesai)
	const filteredTodos = filter === "all" ? todos : todos.filter(todo => todo.isComplete === (filter === "completed"));
