    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center justify-center">
                {/* Icon */}
                <span className="text-white font-bold text-xl flex items-center space-x-2">
                    <svg
                    ...
                    >
                        <path
                            ...
                            strokeWidth="2"
                            d="M9 5v6H7m0 0H5m2 0V5m0 0v6h2m6 0v6h2m-2 0h2m0 0V5m0 0v6h-2m-2 0H9m2 0v6M5 15h14"
                        ></path>
                    </svg>
                    <span>To-Do Shit</span>
                </span>
            </div>
